...
xterm -geometry 73x18+22+48 -bg black -fg green -fa ‘verdana’ -fs 9x -T DUMP1090 -e sudo /home/pi/dump1090/dump1090 --device-index $index --net --interactive --net-ro-port $raw --gain $gain --net-http-port $http

else
xterm -geometry 73x18+22+48 -bg black -fg green -fa ‘verdana’ -fs 9x -T DUMP1090 -e sudo /home/pi/dump1090/dump1090 --device-index $index --net --interactive --net-ro-port $raw --net-http-port $http
fi
