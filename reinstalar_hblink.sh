...
sudo sed -i "166c \<a href=\"http://$ip:$port/panel_control/panel_control.php\" class=\"btn btn-warning btn-sm mt-auto\"\>DASHBOARD HBLINK3 AÑADIDA\</a>" /var/www/html/panel_control/panel_control.php
