...
xterm -geometry 88x6+1274+665 -bg brown -fg white -fa ‘verdana’ -fs 9x -T YSF2DMR -e sudo ./YSF2DMR YSF2DMR.ini &  

sleep 2

cd /home/pi/MMDVMHost
xterm -geometry 88x9+1274+787 -bg brown -fg white -fa ‘verdana’ -fs 9x -T MMDVMFUSION -e sudo ./MMDVMFUSION MMDVMFUSION.ini
